...
async function getUserData(pool: mysql.Pool, userId: number, language: api.LanguageCodeType, triggerPrettyDownload: boolean, tamerName?: string): Promise<api.UserData> {
    let userReadScenarioIdList = [
        ...
        71007, 71008, 71009, 71010, 71011,
        // These vs. Guardians inserts happened in Japan:
        71111, 71112,
        // These didn't:
        71101, 71102, 71103, 71104, 71105, 71106, 71107, 71108, 71109, 71110, 71113, 71114, 71115,
        80011,
        90011, 90012, 90051, 90052, 90061, 90062, 90201, 90202, 90203, 90204, 90205, 90206, 90071,
        90072, 90101, 90102, 90111, 90112, 90131, 90132, 90141, 90142, 90171, 90172, 90211, 90212,
        90221, 90222, 90231, 90232, 90233, 90234, 90241, 90242, 90251, 90252, 90261, 90262, 90271,
        90272, 90273, 90281, 90282, 90283, 90284, 90291, 90292, 90301, 90302, 90303, 90311, 90312,
        90321, 90322, 90331, 90332, 90333, 90341, 90342, 90351, 90352, 90353, 90361, 90371, 90372,
        90373, 90381, 90391, 90401, 90402, 90411, 90421, 90422, 90431, 90432, 90433, 90441, 90451,
        90461, 90471, 90481, 90491, 90501, 90502, 90511, 90521, 90522, 90523, 90531, 90541, 90551,
        90561, 90562, 90571, 90581, 90591, 90601, 90602, 90603, 90611, 90612, 90621, 90622, 90631,
        90641, 90651, 90652, 90661, 90671, 90681, 90691, 90701, 90711, 90721, 90731, 90741, 90751,
        90761, 90762, 90771, 90781, 90791, 90792, 90801, 90811, 90821, 90822, 90823, 90831, 90832,
        90841, 90842, 90851, 90861, 90881, 90891, 90892, 90911, 90912, 90941, 90971, 90972, 90981,
        90982, 90983, 91001, 91011, 91012, 91031, 91051, 91061, 91081, 91111, 91131, 91141, 91171,
        91181, 91182, 91183, 91201,
        // Other scenarios not on my account even though I should've seen them:
        70031, 70401, 80012,
    ]
